    ...
    internal sealed class Configuration : DbMigrationsConfiguration<TicketingSystem.DAL.Models.TicketingSystemDBContext>
    {
        ...
        protected override void Seed(TicketingSystem.DAL.Models.TicketingSystemDBContext context)
        {
            ...
            context.Tickets.AddOrUpdate(
                new Ticket { ProjectID = 1, TaskName = "Projekat", TaskDescription = "Eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo.", TaskFrom = DateTime.Today, TaskUntil = DateTime.Today.AddDays(5), TaskPriority = "Blocker", TaskStatus = "In Progress", UserCreatedID = "admin", UserAssignedID = "vlada" },
                new Ticket { ProjectID = 1, TaskName = "Usmeni", TaskDescription = "Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.", TaskFrom = DateTime.Today, TaskUntil = DateTime.Today.AddDays(8), TaskPriority = "Critical", TaskStatus = "Verify", UserCreatedID = "admin1" },
                ...
                new Ticket { ProjectID = 2, TaskName = "Usmeni", TaskDescription = "Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.", TaskFrom = DateTime.Today.AddDays(15), TaskUntil = DateTime.Today.AddDays(25), TaskPriority = "Critical", TaskStatus = "To Do", UserCreatedID = "admin1" },
                ...
                new Ticket { ProjectID = 3, TaskName = "Projekat Menadzerski 1", TaskDescription = "Eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo.", TaskFrom = DateTime.Today.AddDays(6), TaskUntil = DateTime.Today.AddDays(8), TaskPriority = "Major", TaskStatus = "To Do", UserCreatedID = "admin" },
                new Ticket { ProjectID = 3, TaskName = "Projekat Menadzerski 2", TaskDescription = "Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam.", TaskFrom = DateTime.Today.AddDays(8), TaskUntil = DateTime.Today.AddDays(10), TaskPriority = "Minor", TaskStatus = "To Do", UserCreatedID = "admin1", UserAssignedID = "aleksa" },
                new Ticket { ProjectID = 3, TaskName = "Specifikacija zahteva", TaskDescription = "Opsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo.", TaskFrom = DateTime.Today.AddDays(-30), TaskUntil = DateTime.Today.AddDays(-20), TaskPriority = "Critical", TaskStatus = "Done", UserCreatedID = "admin" },
                new Ticket { ProjectID = 4, TaskName = "Kolokvijum", TaskDescription = "Veritatis et quasi architecto beatae vitae dicta sunt explicabo.", TaskFrom = DateTime.Today.AddDays(8), TaskUntil = DateTime.Today.AddDays(8), TaskPriority = "Critical", TaskStatus = "To Do", UserCreatedID = "admin1" },
                new Ticket { ProjectID = 4, TaskName = "Projekat", TaskDescription = "Lo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo.", TaskFrom = DateTime.Today.AddDays(8), TaskUntil = DateTime.Today.AddDays(10), TaskPriority = "Blocker", TaskStatus = "In Progress", UserCreatedID = "admin" },
                new Ticket { ProjectID = 4, TaskName = "Usmeni II", TaskDescription = "Eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo.", TaskFrom = DateTime.Today, TaskUntil = DateTime.Today.AddDays(5), TaskPriority = "Blocker", TaskStatus = "In Progress", UserCreatedID = "admin1", UserAssignedID = "aleksa" },
                new Ticket { ProjectID = 5, TaskName = "Prijava", TaskDescription = "Quis autem vel eum iure reprehenderit qui in ea voluptate velit esse quam nihil molestiae consequatur.", TaskFrom = DateTime.Today.AddDays(35), TaskUntil = DateTime.Today.AddDays(45), TaskPriority = "Minor", TaskStatus = "Verify", UserCreatedID = "admin" },
                new Ticket { ProjectID = 5, TaskName = "Izrada", TaskDescription = "Inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo.", TaskFrom = DateTime.Today, TaskUntil = DateTime.Today.AddDays(5), TaskPriority = "Critical", TaskStatus = "InProgress", UserCreatedID = "admin" },
                new Ticket { ProjectID = 5, TaskName = "Odbrana", TaskDescription = "Autem vel eum iure reprehenderit qui in ea voluptate velit esse quam nihil molestiae consequatur", TaskFrom = DateTime.Today, TaskUntil = DateTime.Today.AddDays(5), TaskPriority = "Blocker", TaskStatus = "To Do", UserCreatedID = "admin1", UserAssignedID = "nikola" }
            );
